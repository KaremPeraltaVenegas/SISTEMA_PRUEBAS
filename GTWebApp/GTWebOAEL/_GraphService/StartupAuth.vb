...
Namespace graph_tutorial
    Partial Public Class StartupAuth
        'Private Shared appId As String = ConfigurationManager.AppSettings("ida:AppId")
        'Private Shared appSecret As String = ConfigurationManager.AppSettings("ida:AppSecret")
        ...
        '    Dim idClient = ConfidentialClientApplicationBuilder.Create(appId).WithRedirectUri(redirectUri).WithClientSecret(appSecret).Build()
