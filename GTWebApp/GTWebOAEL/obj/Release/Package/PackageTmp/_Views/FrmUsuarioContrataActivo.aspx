<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main.master" CodeBehind="FrmUsuarioContrataActivo.aspx.vb" Inherits="GTWebOAEL.FrmUsuarioContrataActivo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
      <script type="text/javascript" src="../_GTJScript/_jquery-3.3.0.min.js" ></script>
  <script type="text/javascript" src="../_GTJScript/Usuariocontrata.js" ></script> <%--MODIFICAR--%>
                  ...
                  <dx:GridViewToolbar EnableAdaptivity="True" Position="Top" ItemAlign="Right">
                      <Items>
                          ...
                          <dx:GridViewToolbarItem ItemStyle-Width="100%" Visible="true">  
                             ...
                             <dx:GridViewToolbarItem Text="" Name="">
                             <Template>
                                 <table style="width:380px;">
                                     <tr>
                                         <td style="font-size:0.75em;">
                                            Si desea dar de baja a algún usuario, remitir los datos al correo 
                                             <b>procesos.aaq@manpowerperu.pe</b> para su atención.
                                         </td>
                                     </tr>
                                 </table>
                             </Template>
