...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript" src="../_GTJScript/AnexoAdmision.js"></script>
    <script type="text/javascript" src="../_GTJScript/_GTHandleMainDetalle.js"></script>
    ...
    <div id="ContentTablaRegistros" style="padding: 0px 15px 0px 15px;">
        <div id="gtTitleTableMain">[ dfasdf ]</div>
                                                        ...
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer>
                                                                ...
                                                                <dx:ASPxComboBox ID="iCodContratistaContrato" runat="server" ValueType="System.String" ClientInstanceName="iCodContratistaContrato">
                                                                    ...
                                                                    <ClientSideEvents SelectedIndexChanged="iCodContratistaContrato_SelectedIndexChanged"></ClientSideEvents>
                                                                </dx:ASPxComboBox>
                                                ...
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer>
                                                        ...
                                                        <dx:ASPxComboBox ID="cOcupacion" runat="server"
                                                            ...
                                                            <ClientSideEvents SelectedIndexChanged="cOcupacion_SelectedIndexChanged"></ClientSideEvents>
                                                            <ValidationSettings RequiredField-IsRequired="true" Display="Dynamic" />
                                                            <Columns>
                                                        ...
                                                        <table class="OAELStat" style="">
                                                            <tr>
                                                                <td style="padding-right: 15px; padding-top: 4px;">
                                                                    <span id="oaelCondicion">asd
                                                                    </span>
                                                                    <span id="oaelExpediente">asd
                                                                    </span>
                                                                    <%-- <span id="oaelFFLL">
                                                                        asd
                                                                      </span>--%>

                                                                    <span id="oaelEmpresa"></span>
                                                        ...
                                                        <table class="OAELStat" style="">
                                                            <tr>
                                                                <td style="padding-right: 15px; padding-top: 4px;">
                                                                    ...
                                                                    <span id="pgiData"></span>


                                                                    <span id="pgiFecha"></span>
